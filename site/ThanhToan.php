...
if (isset($_POST['OK'])) {
    ...
    // Inside the section that displays order details after the user clicks "Đặt hàng"
    echo "
...
<body>
    ...
    <div class="row">
        <form action="" method="POST">
            ...
            <div class="col-md-8">
                <button type="submit" name="OK" class="btn btn-success">Đặt hàng</button>
            </div>
        </form>
    </div>
    ...
    <div class="row">
        <div class="col-md-4" style="background-color: #f5f3f1;">
            ...
            <p><b>Phí vận chuyển:</b> <?php echo number_format($phivc ?? 0, 0); ?> VNĐ</p>
            <p><b>Tổng cộng:</b> <?php echo number_format($tongtien + ($phivc ?? 0), 0); ?> VNĐ</p>
        </div>
    </div>
